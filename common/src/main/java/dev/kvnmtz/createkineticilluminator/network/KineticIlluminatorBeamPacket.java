...
public class KineticIlluminatorBeamPacket extends BaseS2CMessage {
    ...
    public KineticIlluminatorBeamPacket(Vec3 barrelPos, InteractionHand usedHand, boolean self, BlockPos targetPos,
                                        ShootType shootType) {
    ...
    public KineticIlluminatorBeamPacket(FriendlyByteBuf buf) {
